...
void GUI_Show(void)
{
  ...
  if (sLCD_DIS.LCD_Dis_Column > sLCD_DIS.LCD_Dis_Page) { //Horizontal screen display
    ...
    DEBUG("Draw Status Area\r\n");
    //Draw Status area 
    //GUI_DrawRectangle(1, 1, 220, 88, BLACK, DRAW_EMPTY, DOT_PIXEL_2X2);
    GUI_DisString_EN(5, 5, "Bench PSU", &Font20, LCD_BACKGROUND, RED);
    GUI_DisString_EN(5, 25, "v6.2 Apr 19", &Font16, LCD_BACKGROUND, WHITE);
    GUI_DisString_EN(5, 59, "Power", &Font16, LCD_BACKGROUND, WHITE);
    GUI_DisString_EN(5, 79, "Oscilloscope", &Font16, LCD_BACKGROUND, WHITE);
    GUI_DisString_EN(5, 99, "Component Meter", &Font16, LCD_BACKGROUND, WHITE);
    GUI_DisString_EN(5, 119, "Soldering Iron", &Font16, LCD_BACKGROUND, WHITE);
    
     DEBUG("Draw Soldering Iron Temperature Control\r\n");
    
     GUI_DisString_EN(270, 9, "Soldering Iron", &Font16, LCD_BACKGROUND, WHITE);
     GUI_DisString_EN(245, 29, "Temperature Control", &Font16, LCD_BACKGROUND, WHITE);
     GUI_DrawRectangle(242, 47, 458, 138,  WHITE, DRAW_EMPTY, DOT_PIXEL_2X2);
     GUI_DrawRectangle(242, 47, 349, 99,  WHITE, DRAW_EMPTY, DOT_PIXEL_2X2);
     GUI_DrawRectangle(349, 47, 458, 99,  WHITE, DRAW_EMPTY, DOT_PIXEL_2X2);
     GUI_DisString_EN(245, 54, "Target", &Font16, LCD_BACKGROUND, WHITE);
     GUI_DisString_EN(352, 54, "Current", &Font16, LCD_BACKGROUND, WHITE);
     //GUI_DisNum(5, 215, num, &Font24, LCD_BACKGROUND, BLUE);
     //GUI_DisString_EN(255, 70, "000", &Font24, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(323, 67, "o", &Font8, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(325, 70, "C", &Font24, LCD_BACKGROUND, GREEN);
     //GUI_DisNum(5, 215, num, &Font24, LCD_BACKGROUND, BLUE);
     //GUI_DisString_EN(364, 70, "000", &Font24, LCD_BACKGROUND, RED);
     GUI_DisString_EN(432, 67, "o", &Font8, LCD_BACKGROUND, RED);
     GUI_DisString_EN(434, 70, "C", &Font24, LCD_BACKGROUND, RED);


     DEBUG("Draw Power Rail Monitor\r\n");

     GUI_DrawRectangle(150, 148, 479, 319,  WHITE, DRAW_EMPTY, DOT_PIXEL_2X2);
     GUI_DrawLine(150, 179, 479, 179, WHITE, LINE_SOLID, DOT_PIXEL_2X2);
     GUI_DrawLine(219, 148, 219, 319, WHITE, LINE_SOLID, DOT_PIXEL_2X2);
     GUI_DrawLine(349, 148, 349, 319, WHITE, LINE_SOLID, DOT_PIXEL_2X2);
     GUI_DisString_EN(153, 155, "Rail", &Font16, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(222, 155, "Voltage(V)", &Font16, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(352, 155, "Current(A)", &Font16, LCD_BACKGROUND, GREEN);
     
     GUI_DisString_EN(160, 186, "3V3", &Font20, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(228, 186, "00.000", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(326, 186, "V", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(358, 186, "00.000", &Font20, LCD_BACKGROUND, CYAN);
     GUI_DisString_EN(456, 186, "A", &Font20, LCD_BACKGROUND, CYAN);
     
     GUI_DisString_EN(160, 213, " 5V", &Font20, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(228, 213, "00.000", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(326, 213, "V", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(358, 213, "00.000", &Font20, LCD_BACKGROUND, CYAN);
     GUI_DisString_EN(456, 213, "A", &Font20, LCD_BACKGROUND, CYAN);
     
     GUI_DisString_EN(160, 240, "12V", &Font20, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(228, 240, "00.000", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(326, 240, "V", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(358, 240, "00.000", &Font20, LCD_BACKGROUND, CYAN);
     GUI_DisString_EN(456, 240, "A", &Font20, LCD_BACKGROUND, CYAN);
     
     GUI_DisString_EN(160, 267, "VR1", &Font20, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(228, 267, "00.000", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(326, 267, "V", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(358, 267, "00.000", &Font20, LCD_BACKGROUND, CYAN);
     GUI_DisString_EN(456, 267, "A", &Font20, LCD_BACKGROUND, CYAN);
     
     GUI_DisString_EN(160, 294, "VR2", &Font20, LCD_BACKGROUND, GREEN);
     GUI_DisString_EN(228, 294, "00.000", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(326, 294, "V", &Font20, LCD_BACKGROUND, YELLOW);
     GUI_DisString_EN(358, 294, "00.000", &Font20, LCD_BACKGROUND, CYAN);
     GUI_DisString_EN(456, 294, "A", &Font20, LCD_BACKGROUND, CYAN);
    ...
    //GUI_DrawCircle( Cx4, Cy4, Cr, WHITE, DRAW_EMPTY, DOT_PIXEL_2X2);
   ...
   // GUI_DisNum(80, 150, 1234567890, &Font12, LCD_BACKGROUND, BLUE);
    ...
    GUI_DisString_EN(40, 120, "WaveShare Electronic", &Font8, LCD_BACKGROUND, BLUE);
